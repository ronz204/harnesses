<!--
Template for .agents/agents/<name>.md — a subagent: a bounded, repeatable
...
project's actual conventions — pull specifics from .agents/rules/ and
.agents/docs/ rather than generic reviewer advice. Same volatile-vs-durable
