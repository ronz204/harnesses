...
- Any `.agents/docs/*` claim that describes this slice.
- Any `.agents/rules/*` convention that should apply to it (e.g. a naming convention, an access-control pattern, a data-handling rule — whatever this project's actual rules cover).
